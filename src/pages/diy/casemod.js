...
const Casemod = () => {
    return(<main>
        <Head>
            <title>Ω - Case DIY Project</title>
        </Head>
        <Menu active="diy"/>
        <Hexagons/>
        <div className="content-column">
            ...
            <p>
                ...
                the front panel will be a black acryl. You can't see through unless the lights in the
                case are on.
            </p>
            <p>
                Other materials are a 140mm fan, magnets for the side panels. An SD cardreader with an
                eject
                mechanism which I pulled out of an MP3 player, and feet, that came off my amplifier, for
                my stereo
                installation to fit the audio cabinet.
            </p>
            <p>
                I made slides to fit 5 HDD's without any screws and sew some holes out of the acrylic
                panel for air
                inlet. The side panels will be held by 4 magnets, which I will fitt seamlessly into the
                wood. I
                don't know yet if this experiment will succeed. I bought a modular PSU, so that I don't
                have any
                cables in the case that I don't use.
            </p>
            <p>
                At the DIY store they weren't able to saw pieces smaller than 100mm, but then the front
                HDD slide
                would be in the way. It would be nice if all drives are visible through the window.
                Upside is that
                the drives are further away from the PSU and its magnetic field.
            </p>
            <p>
                The optical drive is a Plextor PX-716AL, with a slot-in mechanism, so I only have to
                make a hole
                big enough to fit a DVD.
            </p>
            <p>
                One week after the Sziget festival, I received a package. It contains an on-button,
                reset-button
                and the acrylic panels. I had to do some research to find out how the buttons have to be
                connected
                (5 pins: + and - for the LED, a Common, a Normally Open and a Normally Closed pin) and
                the pin
                layout of the header on the main board, but in the end this all wasn't a problem. I had
                to remove
                the molex connector of the fan controller and solder the connection to the PSU directly
                on it,
                here it's also nice to have a modular PSU. I had some trouble with the GPU though, I
                didn't get
                any signal on my monitor, but the GPU is a new one and I didn't get any beeps from the
                main board.
                I tried my old GPU, but no signal either. I was afraid the main board was broken, that
                has happened
