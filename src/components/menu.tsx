...
type Props = {
	active?: 'home' | 'resume' | 'diy' | 'travels' | 'bookmarks' | 'whisky'
};
		...
		<div className="menu-wrap">
			<nav className="menu">
				<div className="icon-list">
					...
					<Link href="/travels" className={travels} id="travels-item">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
					...
					<Link href="/travels/mobile" className={travels} id="travels-item-mobile">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
							<path d="M16 0c-8.837 0-16 7.163-16 16s7.163 16 16 16 16-7.163 16-16-7.163-16-16-16zM16 30c-1.967 0-3.84-0.407-5.538-1.139l7.286-8.197c0.163-0.183 0.253-0.419 0.253-0.664v-3c0-0.552-0.448-1-1-1-3.531 0-7.256-3.671-7.293-3.707-0.188-0.188-0.442-0.293-0.707-0.293h-4c-0.552 0-1 0.448-1 1v6c0 0.379 0.214 0.725 0.553 0.894l3.447 1.724v5.871c-3.627-2.53-6-6.732-6-11.489 0-2.147 0.484-4.181 1.348-6h3.652c0.265 0 0.52-0.105 0.707-0.293l4-4c0.188-0.188 0.293-0.442 0.293-0.707v-2.419c1.268-0.377 2.61-0.581 4-0.581 2.2 0 4.281 0.508 6.134 1.412-0.13 0.109-0.256 0.224-0.376 0.345-1.133 1.133-1.757 2.64-1.757 4.243s0.624 3.109 1.757 4.243c1.139 1.139 2.663 1.758 4.239 1.758 0.099 0 0.198-0.002 0.297-0.007 0.432 1.619 1.211 5.833-0.263 11.635-0.014 0.055-0.022 0.109-0.026 0.163-2.541 2.596-6.084 4.208-10.004 4.208z"></path>
						</svg>
						<span>Travels</span>
					</Link>
					<Link href="/whisky" className={whisky}>
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
							<path d="M6 0v32l10-10 10 10v-32z"></path>
						</svg>
						<span>Whisky</span>
					</Link>
					<Link href="/cabinet" className={diy}>
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 482.568 482.568">
							...
							<path d="M309.193,243.918l-22.7,22.6l134.8,134.8c5.1,5.1,5.1,13.4,0,18.5s-13.4,5.1-18.5,0l-134.8-134.8l-22.7,22.6l138.9,138.9      c17.6,17.6,46.1,17.5,63.7-0.1s17.6-46.1,0.1-63.7L309.193,243.918z"></path>
							<path d="M361.293,153.918h59.9l59.9-119.7l-29.9-29.9l-119.8,59.8v59.9l-162.8,162.3l-29.3-29.2l-118,118      c-24.6,24.6-24.6,64.4,0,89s64.4,24.6,89,0l118-118l-29.9-29.9L361.293,153.918z"></path>
						</svg>
						<span>DIY Cabinet</span>
					</Link>
					<Link href="/bookmarks" className={bookmarks}>
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
							<path d="M6 0v32l10-10 10 10v-32z"></path>
						</svg>
						<span>Bookmarks</span>
			...
			<svg viewBox="0 0 200 220" xmlns="http://www.w3.org/2000/svg" id="menu-hexagons">
				...
				<text x="28" y="30" transform="rotate(-30 20,40) skewX(30)" fill="#000000" fontSize="16" letterSpacing={.1} fontWeight="bold">ME</text>
				<text x="50" y="51" transform="rotate(-30 20,40) skewX(30)" fill="#000000" fontSize="16" letterSpacing={.1} fontWeight="bold">NU</text>
			</svg>
		</div>
	</>);
}