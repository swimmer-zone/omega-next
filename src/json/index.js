...
import whisky_finish from './whisky_finish.json';
import whisky_flavour from './whisky_flavour.json';
import whisky_link_category from './whisky_link_category.json';
