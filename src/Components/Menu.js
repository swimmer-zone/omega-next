...
const Menu = ({ active }) => {
	...
	if (typeof document !== 'undefined') {
		...
		openbtn = document.getElementById('menu-hexagons');
	}
    ...
    return (<>
		<div className="menu-wrap">
			...
			<svg viewBox="0 0 300 900" xmlns="http://www.w3.org/2000/svg" id="menu-hexagons">
				<path className="hex1" d="m40,0 l 17.32,10 l0,20 l-17.32,10 l-17.32,-10 l0,-20 z"/>
				<path className="hex2" d="m80,0 l 17.32,10 l0,20 l-17.32,10 l-17.32,-10 l0,-20 z"/>
				<path className="hex3" d="m60,34 l 17.32,10 l0,20 l-17.32,10 l-17.32,-10 l0,-20 z"/>

				<path className="hex4" d="m20,34 l 17.32,10 l0,20 l-17.32,10 l-17.32,-10 l0,-20 z"/>
				<path className="hex5" d="m60,34 l 17.32,10 l0,20 l-17.32,10 l-17.32,-10 l0,-20 z"/>
				<path className="hex6" d="m100,34 l 17.32,10 l0,20 l-17.32,10 l-17.32,-10 l0,-20 z"/>

				<path className="hex7" d="m40,68 l 17.32,10 l0,20 l-17.32,10 l-17.32,-10 l0,-20 z"/>
				<path className="hex8" d="m80,68 l 17.32,10 l0,20 l-17.32,10 l-17.32,-10 l0,-20 z"/>
				<path className="hex9" d="m120,68 l 17.32,10 l0,20 l-17.32,10 l-17.32,-10 l0,-20 z"/>

				<path className="hex10" d="m20,102 l 17.32,10 l0,20 l-17.32,10 l-17.32,-10 l0,-20 z"/>
				<path className="hex11" d="m60,102 l 17.32,10 l0,20 l-17.32,10 l-17.32,-10 l0,-20 z"/>
				<path className="hex12" d="m100,102 l 17.32,10 l0,20 l-17.32,10 l-17.32,-10 l0,-20 z"/>

				<path className="hex13" d="m40,136 l 17.32,10 l0,20 l-17.32,10 l-17.32,-10 l0,-20 z"/>
				<path className="hex14" d="m80,136 l 17.32,10 l0,20 l-17.32,10 l-17.32,-10 l0,-20 z"/>
				<path className="hex15" d="m120,136 l 17.32,10 l0,20 l-17.32,10 l-17.32,-10 l0,-20 z"/>
			</svg>
		</div>
